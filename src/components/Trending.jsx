...
const Trending = () => {
  return (
    <div className='bg-[#090B1A] py-14 px-4'>
        ...
        <div>
            <h4 className='text-[#0dd71491] font-bold mb-4 text py-2 px-2'>TRENDING</h4>
        </div>
        <div className='flex justify-between items-start flex-col xl:flex-row px-2'>
            <h2 className='font-bold text-3xl mb-4  text-white'>Trending Now</h2>
            <p className='mb-4 text-white'>Check out our latest collection of games</p>
            <button className="bg-[#0dd71491]  hover:bg-[#0dd71446] hover:scale-110 transform transition duration-500 px-10 py-2 font-bold rounded-sm mb-6 text-white">View All</button>
        </div>
